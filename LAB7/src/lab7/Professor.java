...
public class Professor extends Funcionario{
	...
	private ArrayList <String> orientandosDoProfessor;
	...
	public Professor(String nome, String cpf, double salario, int materia1, int materia2, int materia3, String orientando) {
		...
		this.materiasQueProfessorLeciona[1] = materia2;
		this.materiasQueProfessorLeciona[2] = materia3;
		this.orientandosDoProfessor.add(orientando);
	}
	...
	public ArrayList<String> getOrientandosDoProfessor() {
		return orientandosDoProfessor;
	}
	public void setOrientandosDoProfessor(ArrayList<String> orientandosDoProfessor) {
