...
public class Professor extends Funcionario{
	...
	public Professor(String nome, String cpf, double salario, int matricula ,int materia1, int materia2, int materia3, ArrayList <String> orientandos) {
	...
	public Professor(String nome, String cpf, double salario, int matricula ,int materia1, int materia2, int materia3) {
		this (nome, cpf, salario, matricula, materia1, materia2, materia3, null);
	}
